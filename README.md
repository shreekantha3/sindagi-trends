# TRENDS — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-trends/
- **Repo:** `shreekantha3/sindagi-trends` (branch `main` = source, `gh-pages` = deployed bundle)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-trends/'` for GitHub Pages project-site hosting.
